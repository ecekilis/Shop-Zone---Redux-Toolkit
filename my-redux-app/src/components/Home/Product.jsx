...
const Product = ({ product }) => {
    ...
    return (
        <div onClick={() => navigate(`products/${product.id}`)} className='w-[460px] p-3 mb-5 mx-5 border hover:bg-gray-100 cursor-pointer rounded-md relative'>
            ...
            <img className='w-[200px] object-cover m-auto' src={product?.image} alt="" />
